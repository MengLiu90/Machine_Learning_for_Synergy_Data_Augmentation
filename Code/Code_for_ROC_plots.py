...
aug_tpr_ts_all = []
for ts in tissues:
    tpr = np.load(f'Data/ClassicalML/RF_tissue_samples_keep/results/test_tpr_ts_{ts}.npy')
    fpr = np.load(f'Data/ClassicalML/RF_tissue_samples_keep/results/test_fpr_ts_{ts}.npy')
    ...
    tpr_aug = np.load(
        f'Data/ClassicalML/RF_tissue_samples_keep/results/aug_test_tpr_ts_{ts}.npy')  # tpr with augmented data
    fpr_aug = np.load(
        f'Data/ClassicalML/RF_tissue_samples_keep/results/aug_test_fpr_ts_{ts}.npy')  # fpr with augmented data
...
for fold in range(folds):
    tpr = np.load(f'Data/ClassicalML/RF_rand_samples_keep/results/test_tpr_fold_{fold}.npy')
    fpr = np.load(f'Data/ClassicalML/RF_rand_samples_keep/results/test_fpr_fold_{fold}.npy')
    ...
    aug_tpr = np.load(f'Data/ClassicalML/RF_rand_samples_keep/results/aug_test_tpr_fold_{fold}.npy')
    aug_fpr = np.load(f'Data/ClassicalML/RF_rand_samples_keep/results/aug_test_fpr_fold_{fold}.npy')
...
for ts in tissues:
    tpr_all_eps = []
    aug_tpr_all_eps = []
    tpr = np.load(f'Data/ClassicalML/GBT_tissue_samples_keep/results/test_tpr_ts_{ts}.npy')
    fpr = np.load(f'Data/ClassicalML/GBT_tissue_samples_keep/results/test_fpr_ts_{ts}.npy')
    mean_auc = metrics.auc(fpr, tpr)
    ...
    tpr_aug = np.load(
        f'Data/ClassicalML/GBT_tissue_samples_keep/results/aug_test_tpr_ts_{ts}.npy')  # tpr with augmented data
    fpr_aug = np.load(
        f'Data/ClassicalML/GBT_tissue_samples_keep/results/aug_test_fpr_ts_{ts}.npy')  # fpr with augmented data
...
aug_tpr_all_folds = []
for fold in range(folds):
    tpr = np.load(f'Data/ClassicalML/GBT_rand_samples_keep/results/test_tpr_fold_{fold}.npy')
    fpr = np.load(f'Data/ClassicalML/GBT_rand_samples_keep/results/test_fpr_fold_{fold}.npy')
    auc = metrics.auc(fpr, tpr)
    ...
    aug_tpr = np.load(f'Data/ClassicalML/GBT_rand_samples_keep/results/aug_test_tpr_fold_{fold}.npy')
    aug_fpr = np.load(f'Data/ClassicalML/GBT_rand_samples_keep/results/aug_test_fpr_fold_{fold}.npy')
    aug_auc = metrics.auc(aug_fpr, aug_tpr)
