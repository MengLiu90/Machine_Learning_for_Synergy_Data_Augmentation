## this file run gradient boosting trees with original and augmented dataset under random split
...
for train_index, test_index in skf.split(df, df.iloc[:, 5]):
    ...
    sample_keep = pd.read_csv(f'Data/GBT_random_split/fold_{fold_cnt}.csv')
    ...
    # np.save(f'Results/GBT_random_split/train_fpr_fold_{fold_cnt}.npy', fpr_train)
    # np.save(f'Results/GBT_random_split/train_tpr_fold_{fold_cnt}.npy', tpr_train)

    np.save(f'Results/GBT_random_split/test_fpr_fold_{fold_cnt}.npy', fpr)
    np.save(f'Results/GBT_random_split/test_tpr_fold_{fold_cnt}.npy', tpr)
    ...
    np.save(f'Results/GBT_random_split/aug_test_fpr_fold_{fold_cnt}.npy', fpr_aug)
    np.save(f'Results/GBT_random_split/aug_test_tpr_fold_{fold_cnt}.npy', tpr_aug)
    ...
    np.save(f'Results/GBT_random_split/confusion_matrix_fold_{fold_cnt}.npy', confusionmatrix)
    np.save(f'Results/GBT_random_split/confusion_matrix_aug_fold_{fold_cnt}.npy', confusionmatrix_aug)
...
df_tr_acc.to_csv('Results/GBT_random_split/train_accuracy.csv', index=False)
df_tr_auc.to_csv('Results/GBT_random_split/train_roc_auc.csv', index=False)
df_test_acc.to_csv('Results/GBT_random_split/test_accuracy.csv', index=False)
df_test_auc.to_csv('Results/GBT_random_split/test_roc_auc.csv', index=False)

df_aug_tr_acc.to_csv('Results/GBT_random_split/aug_train_accuracy.csv', index=False)
df_aug_tr_auc.to_csv('Results/GBT_random_split/aug_train_roc_auc.csv', index=False)
df_aug_test_acc.to_csv('Results/GBT_random_split/aug_test_accuracy.csv', index=False)
df_aug_test_auc.to_csv('Results/GBT_random_split/aug_test_roc_auc.csv', index=False)

df_precision_score.to_csv('Results/GBT_random_split/precision_score.csv', index=False)
df_precision_score_aug.to_csv('Results/GBT_random_split/precision_score_aug.csv', index=False)
df_recall_score.to_csv('Results/GBT_random_split/recall_score.csv', index=False)
df_recall_score_aug.to_csv('Results/GBT_random_split/recall_score_aug.csv', index=False)
df_f1.to_csv('Results/GBT_random_split/f1_score.csv', index=False)
df_f1_aug.to_csv('Results/GBT_random_split/f1_score_aug.csv', index=False)
