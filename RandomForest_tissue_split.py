## this file run the random forest with original and augmented datasets under tissue split
...
file = tarfile.open('Data/RandomForest_tissue_split/breast.tgz')
# extracting file
file.extractall('./Data/RandomForest_tissue_split')
file.close()
...
for ts in tissues:
    ...
    sample_keep = pd.read_csv(f'Data/RandomForest_tissue_split/{ts}.csv')
    ...
    np.save(f'Results/RandomForest_tissue_split/y_train_score_{ts}.npy', y_train_score)
    ...
    # np.save(f'Results/RandomForest_tissue_split/train_fpr_fold_{fold_cnt}.npy', fpr_train)
    # np.save(f'Results/RandomForest_tissue_split/train_tpr_fold_{fold_cnt}.npy', tpr_train)

    np.save(f'Results/RandomForest_tissue_split/test_fpr_ts_{ts}.npy', fpr)
    np.save(f'Results/RandomForest_tissue_split/test_tpr_ts_{ts}.npy', tpr)
    ...
    # np.save(f'Results/RandomForest_tissue_split/y_train_score_{ts}.npy', y_train_aug_score)
    ...
    np.save(f'Results/RandomForest_tissue_split/aug_test_fpr_ts_{ts}.npy', fpr_aug)
    np.save(f'Results/RandomForest_tissue_split/aug_test_tpr_ts_{ts}.npy', tpr_aug)
    ...
    np.save(f'Results/RandomForest_tissue_split/confusion_matrix_ts_{ts}.npy', confusionmatrix)
    np.save(f'Results/RandomForest_tissue_split/confusion_matrix_aug_ts_{ts}.npy', confusionmatrix_aug)
...
df_tr_acc.to_csv('Results/RandomForest_tissue_split/train_accuracy.csv', index=False)
df_tr_auc.to_csv('Results/RandomForest_tissue_split/train_roc_auc.csv', index=False)
df_test_acc.to_csv('Results/RandomForest_tissue_split/test_accuracy.csv', index=False)
df_test_auc.to_csv('Results/RandomForest_tissue_split/test_roc_auc.csv', index=False)

df_aug_tr_acc.to_csv('Results/RandomForest_tissue_split/aug_train_accuracy.csv', index=False)
df_aug_tr_auc.to_csv('Results/RandomForest_tissue_split/aug_train_roc_auc.csv', index=False)
df_aug_test_acc.to_csv('Results/RandomForest_tissue_split/aug_test_accuracy.csv', index=False)
df_aug_test_auc.to_csv('Results/RandomForest_tissue_split/aug_test_roc_auc.csv', index=False)

df_precision_score.to_csv('Results/RandomForest_tissue_split/precision_score.csv', index=False)
df_precision_score_aug.to_csv('Results/RandomForest_tissue_split/precision_score_aug.csv', index=False)
df_recall_score.to_csv('Results/RandomForest_tissue_split/recall_score.csv', index=False)
df_recall_score_aug.to_csv('Results/RandomForest_tissue_split/recall_score_aug.csv', index=False)
df_f1.to_csv('Results/RandomForest_tissue_split/f1_score.csv', index=False)
df_f1_aug.to_csv('Results/RandomForest_tissue_split/f1_score_aug.csv', index=False)
